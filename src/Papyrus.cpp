...
namespace DeviousDevices {
    ...
    {
        REL::Relocation<RE::ObjectRefHandle*> selectedRef{ RELOCATION_ID(519394, 504099) };
    ...
    static inline void ConsoleUtil_CompileAndRun(RE::Script* script, RE::TESObjectREFR* targetRef, RE::COMPILER_NAME name = RE::COMPILER_NAME::kSystemWindowCompiler)
    {
        ...
        REL::Relocation<void(RE::Script* script, RE::ScriptCompiler* compiler, RE::COMPILER_NAME name, RE::TESObjectREFR* targetRef)> func{ RELOCATION_ID(21416, 441582) };
